...
const TodoItem = ({ todo, category, onToggleStatus, onDeleteTodo, onEditTodo }) => {
  ...
  return (
    <div className={`p-4 sm:px-6 sm:py-4 hover:bg-gray-50 transition-colors ${
      ...
      <div className="block sm:hidden space-y-3">
        <div className="flex items-start gap-3">
          {category && (
            <div className={`flex items-center justify-center w-8 h-8 ${category.color} rounded-full flex-shrink-0 mt-1`}>
        ...
        <div className="flex items-center justify-between gap-3">
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium transition-colors flex-1 justify-center ${
              todo.status === 'completed'
